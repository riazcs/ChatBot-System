        ...
        <div class="inner-bg">
            <div class="container">
              ...
              <div class="row">
                <div class="col-sm-6 col-sm-offset-3 form-box">
                   <div class="form-top">
                     ...
                     <h5><p>Enter the following to Admin log on -</p></h5>
                 </div> 
                 ...
                 <div class="form-bottom">
                    ...
                    <form role="form" action="" method="post" class="login-form">
                      ...
                      <div class="form-group">
                        <label class="sr-only" for="form-admin_id">User ID</label>
                        <input type="text" name="admin_id" placeholder="User ID..." class="form-admin_id form-control" id="id"required>
              ...
              <div class="row" id="col_4"><div id="row_result_type" ><div class="form-group col-md-12">
                ...
                <center> Not yet member please <a  class="new" href="admin_signup.php">Sign up!</a></center>
                <style>
                .new{
                   color:#090;
               }
