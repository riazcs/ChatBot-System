...
if(empty($aid) && (empty($password)))
{
			...
			echo "<div align='center' style='padding-top:100px' <b>IMBECILE !!</b> YOU MUST LOGIN FIRST.</div>";	
...
$userquery= "select * from admin_tbl where admin_id='$aid'";
...
<html class="no-js" lang="en">
  <head>
    ...
    <title><?php echo ucfirst($aid);?> | MBSTU </title>
